    ...
    <div class="columns is-multiline is-centered">
      <div class="column" v-for="data in feed" :key="data.id">
        <a
          ...
          aria-label="Ultima's Instagram account"
        >
          <figure class="image is-square" v-if="data.type === 'image' || data.type === 'carousel'" :aria-label="`image from instagram with ${!!data.caption.text ? `caption of ${data.caption.text}.` : `no caption.`}`">
            <img :src="data.images.low_resolution.url" alt="Instagram image"
                 loading="lazy" height="200" width="200"
            >
            <div class="insta-overlay" aria-hidden="true">
              <div>
          ...
          <figure class="is-square" v-if="data.type === 'video'" aria-label="`video from instagram with ${!!data.caption.text ? `caption of ${data.caption.text}.` : `no caption.`}`">
